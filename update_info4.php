					...
					<div class="row margin-vert-30">
						...
						<form method="post">
							<?php
								...
								$sql="select * from hotel_search where hotel_id=".$id."";
								...
								if(mysqli_num_rows($rs)==1)
								{
									...
									echo "</tr>";
									echo"<tr><td colspan='5' align='center'><input type='submit' name='btn6' value='UPDATE'></td></tr>";
									echo "</table>";
								}
							?>
						</form>
						<?php
							if(isset($_POST["btn6"]))
							{
								...
								$q="update hotel_search set hotel_name='".$name."', hotel_class='".$class."', hotel_location='".$location."', room_type='".$type."', room_price='".$price."' where hotel_id=".$id."";
