					...
					<div class="row margin-vert-30">
						...
						<form method="post">
							<?php
								...
								$sql="select * from admin_register where admin_id=".$id."";
								...
								if(mysqli_num_rows($rs)==1)
								{
									...
									echo "</tr>";
									echo"<tr><td colspan='2' align='center'><input type='submit' name='btn6' value='UPDATE'></td></tr>";
									echo "</table>";
								}
							?>
						</form>
						<?php
							if(isset($_POST["btn6"]))
							{
								...
								$q="update admin_register set admin_name='".$name."', admin_pass='".$pass."' where admin_id=".$id."";
