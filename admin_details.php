									...
									while($row=mysqli_fetch_row($rs))
										{
											...
											echo "<td><a href='update_info6.php?id=".$row[0]."'>&nbsp;&nbsp;UPDATE&nbsp;&nbsp;</a></td>";
											echo "<td><a href='delete6.php?id=".$row[0]."' onclick='return confirm('Are you sure to delete this entire id?');'>&nbsp;&nbsp;DELETE&nbsp;&nbsp;</a></td>";
											echo "</tr>";
										}
										echo "</table>";
									}
