					...
					<div class="row margin-vert-30">
						...
						<form method="post">
							<?php
								...
								$sql="select * from train_search where train_id=".$id."";
								...
								if(mysqli_num_rows($rs)==1)
								{
									...
									echo "</tr>";
									echo"<tr><td colspan='9' align='center'><input type='submit' name='btn6' value='UPDATE'></td></tr>";
									echo "</table>";
								}
							?>
						</form>
						<?php
							if(isset($_POST["btn6"]))
							{
								...
								$q="update train_search set train_name='".$name."', train_from='".$here."', train_to='".$there."', train_dept_time='".$dept."', train_arr_time='".$arr."', travel_class='".$class."', travel_type='".$type."', train_price='".$price."' where train_id=".$id."";
