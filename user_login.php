                ...
                <div class="container background-white">
					<div class="row margin-vert-30">
						...
						<?php
							...
							echo "Welcome to Login Page!! $name";
									...
									while($row=mysqli_fetch_row($rs))
										{
											...
											echo "<td>$row[7]</td>";
											echo "<td>$row[8]</td>";
											echo "<td><a href='user_booking.php?id=".$row[0]."&class=".trim($row[4])."&type=".'destination'."'>Book</a></td>";
											echo "</tr>";
										}
										echo "</table>";
									}
					...
					<div class="row margin-vert-30">
						<div class="row">
                            <div class="col-md-6">
								<form method="post">
									<button class="btn btn-primary pull-right" type="submit" name="btn3">LOG OUT</button>
								</form>
                            </div>
                        </div>
						<?php
