					...
					<div class="row margin-vert-30">
						...
						<form method="post">
							<?php
								...
								$sql="select * from tour_register where reg_id=".$id."";
								...
								if(mysqli_num_rows($rs)==1)
								{
									...
									echo "</tr>";
									echo"<tr><td colspan='4' align='center'><input type='submit' name='btn2' value='UPDATE'></td></tr>";
									echo "</table>";
								}
							?>
						</form>
						<?php
							if(isset($_POST["btn2"]))
							{
								...
								$q="update tour_register set reg_name='".$name."', reg_email='".$email."', reg_phone='".$phone."', reg_pass='".$pass."' where reg_id=".$id."";
